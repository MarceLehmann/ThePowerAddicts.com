...
const Header: React.FC = () => {
  ...
  const linkClass = "py-2 px-3 text-brand-blue-dark dark:text-gray-200 hover:text-brand-teal dark:hover:text-brand-teal transition-colors duration-300 rounded-md text-sm font-medium";
  const activeLinkClass = "py-2 px-3 text-brand-teal font-semibold bg-brand-teal/10 dark:bg-brand-teal/20 rounded-md text-sm";

  return (
    <header className="bg-white/90 dark:bg-gray-900/90 backdrop-blur-lg sticky top-0 z-50 border-b border-gray-200/80 dark:border-gray-700/80">
      <div className="container mx-auto px-6 py-2 flex justify-between items-center">
        ...
        <div className="hidden lg:flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-1 text-sm text-gray-500 dark:text-gray-400">
                <MvpLogo className="w-5 h-5 text-brand-blue-dark dark:text-brand-teal" />
        ...
        <div className="lg:hidden">
          <button onClick={() => setIsMenuOpen(!isMenuOpen)} className="text-brand-blue-dark dark:text-gray-200 focus:outline-none" aria-label={t('header.openMenu')}>
